(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('os'), require('tty'), require('util'), require('http'), require('https'), require('stream'), require('assert'), require('url'), require('zlib')) :
    typeof define === 'function' && define.amd ? define(['os', 'tty', 'util', 'http', 'https', 'stream', 'assert', 'url', 'zlib'], factory) :
    (global.nocknockSdk = factory(global.os,global.tty,global.util,global.http,global.https,global.stream,global.assert,global.url,global.zlib));
}(this, (function (os,tty,util,http,https,stream,assert,url,zlib) { 'use strict';
    ...
    var NockNock = /** @class */ (function () {
        ...
        NockNock.prototype.init = function (options) {
            ...
            if (options.middleware) {
                ...
                this._httpClient = axios$1.create(__assign(__assign({}, this._config), { withCredentials: !!options.config.withCredentials }));
            }
        };
        return NockNock;
    }());
    var nocknockSdk = new NockNock();
